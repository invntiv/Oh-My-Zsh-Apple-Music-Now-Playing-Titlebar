# Generated by Powerlevel10k configuration wizard on 2019-12-01 at 09:39 CST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 44900.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, time,
# slanted separators, slanted heads, sharp tails, 2 lines, solid, left frame, lightest,
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%004F╭─'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%004F├─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%004F╰─'
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=004
  ...
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='\UE0BA'
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=004
